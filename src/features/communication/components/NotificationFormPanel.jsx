import { Clock, Edit3, MessageSquare, RefreshCw, Send, X } from 'lucide-react'
import Combobox from '../../../components/ui/Combobox'
import { audienceOptions, getCurrentDateTime, notificationTypeOptions, themedInput, themedPrimary, themedPrimaryBorder, themedPrimarySoft } from '../utils/communicationHelpers'

export default function NotificationFormPanel({
  form,
  onFormChange,
  editingNotif,
  routeOptions,
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="datetime-local"
              value={form.schedule}
              onChange={event => onFormChange({ ...form, schedule: event.target.value })}
