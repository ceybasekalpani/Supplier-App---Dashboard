  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 h-14 flex items-center px-6 gap-4">
      <div className="flex-1">
        ...
        <p className="text-xs text-slate-400">Tea Factory · {pageTitle}</p>
      </div>
      <div className="flex items-center gap-2">
        ...
        <button className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors relative">
          <Bell size={16} />
